                ...
                <div className="desc-area">
                    ...
                    <div className="txt-area">
                        <div className="row">
                            ...
                            {link2 && <a href={link2} title="github" target="_blank" rel="noreferrer" style={{color:'#333', fontSize:'11px', marginLeft:'10px'}}><svg height="15" aria-hidden="true" viewBox="0 0 16 16" version="1.1" width="15" data-view-component="true" style={{verticalAlign:'-3px', marginRight:'3px'}}>
